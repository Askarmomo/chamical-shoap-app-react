...
const Sidebar = () => {
    return (
        <div>
            <div className=" max-w-[200px] max-h-full pb-52 bg-cyan-900 text-white space-y-8 pb-full pr-10 pt-12 sticky top-20 left-0 bottom-0">
                <Link to={"/"} className="flex hover:bg-opacity-30 space-x-4 items-center hover:bg-violet-200 rounded-r transition ease-in-out duration-300 hover:scale-105 px-5 py-2 cursor-pointer">
                ...
                <Link to={"login"} className="flex hover:bg-opacity-30 space-x-4 items-center hover:bg-cyan-200 rounded-r transition ease-in-out duration-300 hover:scale-105 px-5 py-2 cursor-pointer">
                ...
                <Link to={"rigister"} className="flex hover:bg-opacity-30 space-x-4 items-center hover:bg-rose-200 rounded-r transition ease-in-out duration-300 hover:scale-105 px-5 py-2 cursor-pointer">
