      ...
      <header className=" bg-gradient-to-r from-cyan-500 to-blue-500 px-10 py-5 flex justify-between ">
        ...
        <div className=" flex space-x-10">
          <div className="relative">
            <input
              className=" p-2.5 text-white opacity-75 bg-transparent pl-10 rounded-full placeholder:text-white outline-none border-2"
              type="text"
              placeholder="Search"
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="text-white -rotate-3 absolute bottom-3.5 left-3"
              width="1.5em"
              height="1.5em"
              viewBox="0 0 256 256"
            >
