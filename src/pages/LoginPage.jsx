...
const LoginPage = () => {
    return (
        <div className=" bg-cyan-800 min-h-screen  w-full">
            ...
            <div className=" w-[800px] flex justify-between items-center mx-auto mt-10 bg-zinc-300/70 backdrop-blur-sm  rounded-xl p-5">
                <div className=" w-full pr-5 space-y-5">
                    <div>
                        <label htmlFor="" className=" font-semibold opacity-70">Enter Email</label>
                        <FormInput placeholder={"Enter Email"} type={"email"} />
                    </div>
                    <div>
                        <label htmlFor="" className=" font-semibold opacity-70">Enter Password</label>
                    ...
                    <div className=" text-center">
                        <small className=" font-semibold opacity-70 items-center"> Login with </small>
                ...
                <div><img className=" w-[900px] h-full object-cover" src="src/images/view-3d-businessman_23-2150709832.avif" alt="" /></div>
            </div>
        </div>
    );
}
